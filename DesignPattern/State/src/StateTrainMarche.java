...
public class StateTrainMarche implements StateTrain {
	...
	public void fermerPorte() {
		throw new IllegalStateException("Les portes sont déjà fermées !");

	}

	@Override
	public void demarrerTrain() {
		throw new IllegalStateException("Le train est déjà en marche !");

	}

	@Override
	public void arreterTrain() {
		System.out.println("Train à l'arret");
